...
#### 递归使用模板
允许递归使用模板。例如可以使用如下代码申请二维数组`ArrayTP<
#### 递归使用模板
允许递归使用模板。例如可以使用如下代码申请二维数组`ArrayTP<rrayTP<int, 5>, 10> twodee;`，其中`ArrayTP<int, 5>`是一个数组，`ArrayTP<ArrayTP<int, 5>, 10>`是一个包含10个`ArrayTP<int, 5>`的数组。
 10> twodee;`，其中`ArrayTP<int, 5>`是一个数组，`ArrayTP<ArrayTP<int, 5>, 10>`是一个包含10个`ArrayTP<int, 5>`的数组。
